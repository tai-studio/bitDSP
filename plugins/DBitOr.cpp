...
void DBitOr_Ctor(DBitOr *unit);
void DBitOr_Dtor(DBitOr *unit);
void DBitOr_next(DBitOr *unit, int inNumSamples);
...
PluginLoad(bitDSPUGens)
{
    ...
    ft = inTable;
    // DefineDtorUnit(bitDSP::DBitOr);
    DefineDtorUnit(DBitOr);
}